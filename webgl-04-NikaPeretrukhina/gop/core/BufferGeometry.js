import { getAttribLocation } from './WebGLProgram.js';
		...
		if (this.isInitialized === false) {
			...
			for (var key in this.attributes) {
				...
				if (attribute.count !== attrCount) {
					const ermsg = `Attribute ${key} has different count ${attribute.count} than other attributes (${attrCount}). All attributes must have the same count! Check array lengths and itemSize.`
					console.error(ermsg);
